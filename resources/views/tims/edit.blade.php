        ...
        <div class="max-w-2xl mx-auto mb-8">
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-600">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-800">Edit Data Tim</h1>
        ...
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6">
                    <h2 class="text-xl font-semibold text-white">Formulir Perbarui Data Tim</h2>
                    <p class="text-blue-100 text-sm mt-1">Perbarui informasi tim dengan benar</p>
                </div>

                <!-- Form Body -->
                <form action="{{ route('tims.update', $tim->id) }}" method="POST" class="p-8 space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="bg-blue-50 border-l-4 border-blue-500 rounded-lg p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <p class="text-blue-800 font-medium text-sm">Sedang mengedit tim: <span class="font-bold">{{ $tim->nama_regu }}</span></p>
                                <p class="text-blue-600 text-xs mt-1">Pastikan semua data sudah benar sebelum menyimpan perubahan</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative">
                            ...
                            >
                                ...
                                @foreach($userUlps as $userUlp)
                                    <option value="{{ $userUlp->id }}" {{ $tim->user_ulp_id == $userUlp->id ? 'selected' : '' }}>
                                        {{ $userUlp->nama_ulp }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="bg-amber-50 border-l-4 border-amber-500 rounded-lg p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <p class="text-amber-800 font-medium text-sm">Perhatian!</p>
                                <p class="text-amber-600 text-xs mt-1">Perubahan data akan langsung tersimpan setelah Anda klik tombol "Perbarui Data"</p>
                            </div>
                        </div>
                    </div>
