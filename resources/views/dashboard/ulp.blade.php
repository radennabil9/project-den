...
<body class="bg-gray-50">
    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen overflow-hidden" x-cloak>
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'"
            class="fixed md:static inset-y-0 left-0 z-40 w-64 bg-gradient-to-b from-emerald-800 to-emerald-950 text-white shadow-xl transform transition-transform duration-300 ease-in-out">
            ...
            <div class="p-6 border-b border-emerald-700 flex justify-between items-center">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-emerald-300 text-xs">User Panel</p>
                    </div>
                </div>
            ...
            <nav class="p-4 space-y-2">
                <a href="/dashboard" class="flex items-center gap-3 px-4 py-3 rounded-lg bg-emerald-700 hover:bg-emerald-600 transition duration-200 group">
                    <i class="bi bi-speedometer2 text-lg"></i>
                    <span class="font-medium">Dashboard</span>
                </a>

                <a href="/tims" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-emerald-700 transition duration-200 group">
                    <i class="bi bi-people-fill text-lg"></i>
                    <span class="font-medium">Tim</span>
                </a>

                <a href="/transaksis" class="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-emerald-700 transition duration-200 group">
            ...
            <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-emerald-700">
                <div class="flex items-center gap-3 px-4 py-3 bg-emerald-900 rounded-lg">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-emerald-300 text-xs uppercase">{{ session('role') }}</p>
                    </div>
                </div>
            </div>
        </aside>
